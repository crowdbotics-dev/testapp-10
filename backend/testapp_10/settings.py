"""
Django settings for testapp_10 project.
...
WSGI_APPLICATION = 'testapp_10.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_10 API",
    "DESCRIPTION": "API documentation for testapp_10 App",
    "VERSION": "v1",
}
